...
<div class="wrapper container">
	<div class="RegBox">
		...
		<form action="/hospitalSystem/trunk/index.php/Home/User/register" method="post" class="fillBox regForm" onSubmit="return reg_submit();">
			...
			<div class="userid" id="userid">
				...
				<span style="display:inline-block;position:relative;"><ul id="mailListBox_1" class="justForJs emailist" style="min-width:292px;_width:292px;position:absolute;left:-6000px;top:37px;z-index:1;"></ul><input name="user_idcard" type="text" class="usr" id="user_id" maxlength="32" autocomplete="off"></span>
				<span class="rightMsg">(请使用就诊者本人有效证件号码注册)</span>
			</div>
<br/>
			<div class="emailaddress" id="emailaddress">
				<label for="vip" class="einfo">邮箱地址:</label>
				<span style="display:inline-block;position:relative;"><ul id="mailListBox_2" class="justForJs emailist" style="min-width:292px;_width:292px;position:absolute;left:-6000px;top:37px;z-index:1;"></ul><input name="user_eamil" type="text" class="usr" id="user_email" maxlength="32" autocomplete="off"></span>
			</div>
<br/>
			<div class="login">
				<label class="einfo" for="pw">登录密码:</label>
				<input id="pwd" type="password" placeholder="6~16位数字、字母或字符组合的密码" class="usr" maxlength="16">
			</div>
			...
			<div class="makesure">
				...
				<input id="pwd2" type="password" placeholder="重复输入密码" class="usr" maxlength="16">
			</div>
			<div class="yanzheng clearfix Regyan" id="Regyan">
				<div class="verblock">
					...
					<div class="pic" >
						<img src="/hospitalSystem/trunk/index.php/Home/User/verify" alt="点击刷新验证码" title="点击刷新验证码" style="height:37px;width:150px;vertical-align:middle;margin-bottom:3px;cursor:pointer;" id="auth_code">
					</div>
				</div>
			</div>
